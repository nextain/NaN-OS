...
- **feat(models)**: Korean domestic models — Upstage Solar Pro 4 (agent-first flagship) and Solar Mini are now selectable Naia models; tool calling was verified against the live Upstage deployment before shipping
