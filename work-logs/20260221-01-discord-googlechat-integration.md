...
Cafelua 서비스에 Discord/Google Chat 양방향 통신 기능 구현 및 빌드 수정.
...
#### 환경변수
- `lab.cafelua.com/.env`에 `DISCORD_BOT_TOKEN`, `DISCORD_OAUTH2_URL` 추가
...
| 파일 | 변경 |
|------|------|
| `flatpak/com.cafelua.shell.yml` | GNOME 47, pnpm, node_modules 복사 |
