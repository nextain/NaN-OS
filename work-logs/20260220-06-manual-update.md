...
## 개요
- **주제**: `naia.nextain.io` 사용자 매뉴얼 최신화 및 스크린샷 갱신
- **상태**: Done
- **날짜**: 2026-02-20
- **목표**: 
  ...
  3. `project-naia.nextain.io/src/content/manual/`의 한국어 및 영어 마크다운 파일에 신규 기능 설명을 추가.
  4. 커밋 및 푸시.

## 진행 계획 및 결과

### Step 1: 스크린샷 자동화 스크립트 업데이트 [완료]
- `Naia-OS/shell/e2e-tauri/specs/99-screenshots.spec.ts` 수정
...
- `project-naia.nextain.io/src/lib/manual-docs.ts` 및 `types.ts` 업데이트 (라우팅 및 다국어 키 추가).
- `project-naia.nextain.io/src/content/manual/ko` 및 `en` 폴더에 `channels.md`, `agents.md`, `diagnostics.md` 파일 추가 완료.
