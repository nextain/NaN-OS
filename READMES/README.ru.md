...
**The Next Generation AI OS** — Персональная настольная операционная система, где живёт ИИ-аватар

[![License](https://img.shields.io/badge/license-Apache%202.0-blue.svg)](../LICENSE)

> «Сама ОС — это инструмент ИИ. ИИ не работает поверх ОС — ИИ управляет ОС.»

## Что такое Naia?

Naia — это десктопное Linux-приложение, в котором постоянно живёт 3D-аватар ИИ. Общайтесь с ИИ через чат и голос, а он напрямую выполняет управление файлами, команды терминала, веб-поиск и написание кода. Любой человек — не только разработчик — может иметь собственного ИИ-агента.

### Основные функции

- **3D-аватар** — VRM-персонаж создаёт живые разговоры с выражением эмоций (радость/грусть/удивление/размышление и т.д.) и синхронизацией губ
- **Мульти-LLM** — Поддержка 7 провайдеров: Gemini, Claude, GPT, Grok, zAI, Ollama, Claude Code CLI
- **Выполнение инструментов** — 8 инструментов, включая чтение/запись файлов, выполнение в терминале, веб-поиск, браузер, суб-агент
- **70 навыков** — 7 встроенных + 63 пользовательских (погода, GitHub, Slack, Notion, Spotify, Discord и т.д.)
- **Голосовое общение** — TTS от 5 провайдеров (Nextain Cloud, Edge, Google, OpenAI, ElevenLabs) + STT
- **14 языков** — Корейский, английский, японский, китайский, французский, немецкий, русский и другие
- **Интеграция каналов** — Общайтесь с ИИ в любое время через Discord DM
- **4-уровневая безопасность** — Иерархия разрешений от T0 (чтение) до T3 (опасно), система одобрения по инструментам, журналы аудита
- **Аккаунт Nextain** — Начните сразу с кредитной системой, без API-ключа
- **Персонализация** — Настройте имя, личность, стиль речи, аватар и тему (8 типов)

## Почему Naia?

Существующие ИИ-инструменты следуют парадигме «люди используют ИИ как инструмент». Naia переворачивает эти отношения — **«Отдать ИИ всю ОС целиком.»**

| Существующий подход | Ограничение | Naia |
|--------------------|-------------|---------|
| **Расширения VS Code** (Copilot, Cline) | Нужно открыть IDE для использования ИИ | IDE не нужна. Всегда включена |
| **CLI-агенты** (Claude Code, Aider) | Работает только в терминале | Управляет файлами, браузером, всей системой |
| **Чат-боты** (ChatGPT, Gemini) | Только чат, не может выполнять | Чат + Выполнение. Скажите «создай файл» — и он действительно создаст |
| **Демон macOS** (OpenClaw) | brew install, только macOS, CLI | Десктопное приложение + 3D-аватар. На базе Linux |
| **ИИ-фреймворки** (LangChain) | Доступны только разработчикам | 7-шаговый онбординг для всех |
