...
- 1920×1080, 30fps, H.264 High Profile, AAC-LC 48kHz stereo
- 음악과 UI 효과음은 권리 확인된 자산만 사용
- Microsoft Store 전용본에는 연령등급 이미지를 영상 안에 넣지 않음
- Steam/외부 홍보본은 배포 국가의 등급 표시 요구를 별도 확인
...
- 출시 빌드에 없는 기능
- 내부 개발 서버 URL, API 키, 개인 대화
- 생성형 AI가 사실을 보장한다는 표현
- 타사 모델 로고를 허가 없이 핵심 브랜드처럼 사용
