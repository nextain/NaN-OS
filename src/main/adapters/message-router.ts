...
/**
 * Rust/gRPC emits the shell approval tier as an integer. Keep the old T0…T3
 * core spelling for existing callers, but reject numeric values outside the
 * shell's documented 0(auto)…2(confirm) range instead of coercing them.
 */
