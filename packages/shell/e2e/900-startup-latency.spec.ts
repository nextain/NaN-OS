...
const SAMPLES = 3;
// 이 기계(RTX 3090 ×2, Bazzite)에서 잰 중앙값은 134ms 였다(표본 704/134/97,
// 첫 표본은 콜드 스타트). 한도는 그 열다섯 배로 둔다 — 목적이 지금 속도를
// 지키는 것이 아니라 배 이상 느려지는 회귀를 잡는 것이기 때문이다. CI 러너는
// 이 기계보다 느리므로, 거기서 한 번 재 보고 여유가 지나치면 줄여라.
