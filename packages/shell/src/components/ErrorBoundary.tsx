...
interface ErrorBoundaryProps {
	/** Identifier for logging — e.g. "App(workspace)" or "ChatArea". */
	scope: string;
	children: ReactNode;
 ...
 *
 * Without this, a render error inside any keepAlive app (e.g. SettingsTab
 * doing `.length` on an undefined IPC result, or SkillLauncher's `.filter`
 * on undefined) propagates up to <App> and unmounts every app — including
 * the Chat app the user is currently looking at.
 */
